...
class Grafo:
    ...
    def addArestas(self, u, v):
        # Grafo direcionado: adiciona aresta u -> v
...
class BFS:
    def __init__(self, g, s):  # s é o índice do vértice de origem
        for v in g.vertices:
            v.cor = 'branco'
            v.d = sys.maxsize
            v.pi = None
...
for v in G.vertices:
    ...
    print(f"  - d: {v.d} - pi: {v.pi.num if v.pi else None}")
